...
export class AppComponent {
  ...
  constructor(public auth: AuthService) {
    addIcons({
      ...
      buildOutline, buildSharp, cubeOutline, cubeSharp, archiveOutline, archiveSharp,
      trendingDownOutline, trendingDownSharp, swapHorizontalOutline, swapHorizontalSharp
    });
  }
