...
export class CategoriesService {
    ...
    updateSubcategory(id: string, nome: string, descricao?: string): Observable<any> {
        return this.api.patch(`financial/categories/${id}`, { nome, descricao });
    }

    createSubcategory(categoriaId: string, nome: string, descricao?: string, tipo: 'RECEITA' | 'DESPESA' = 'DESPESA'): Observable<any> {
        return this.api.post(`financial/categories`, { parentId: categoriaId, nome, descricao, tipo });
    }
